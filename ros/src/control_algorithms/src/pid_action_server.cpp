...
//     derivative = 0;
//   } else {
//     derivative = (error - angular_error_prev) / (time_curr -
//     angular_time_prev);
//   }
...
//     derivative = 0;
//   } else {
//     derivative = (error - linear_error_prev) / (time_curr -
//     linear_time_prev);
//   }
...
// This shit is fucked up lol, should not return (Jaxon), works with goal
// handle,
...
//     // Return early so we don't try moving linearly if we still need to fix
//     our
//     // angle
//     return;
//   }
