...
- `preprocessing` point cloud slicer publishes 3 point clouds correlating to gaps, ground, and obstacles
- `cloud_to_grid` uses the 3 point clouds to create an occupancy style map
- `grid_filter` additional filtering such as robot removal from obstacles
